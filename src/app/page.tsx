        ...
        <div className="px-4 md:px-6 space-y-10 xl:space-y-16">
          <div className="grid max-w-[1300px] mx-auto gap-4 px-4 sm:px-6 md:px-10 md:grid-cols-2 md:gap-16">
            ...
            <div className="flex flex-col items-start space-y-4">
              ...
              <div className="flex flex-col w-full md:flex-row gap-2 whitespace-nowrap">
                <Link
        ...
        <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
          ...
          <div className="space-y-3 z-50">
            ...
            <div className="bg-white">
              <p className="p-2 mx-auto max-w-[600px] text-black md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
